...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            # Train the model only if it's not already trained
            if not indicator_calculator.is_model_trained:
                logger.info("Training the model as no pre-trained model was found.")
                indicator_calculator.train_model(combined_df)
            else:
                logger.info("Using the pre-trained model.")
